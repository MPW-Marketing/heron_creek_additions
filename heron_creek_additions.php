...
function heron_creek_scripts_method() {
    ...
    wp_register_script( 'jscrollpane', plugins_url( '/js/jquery.jscrollpane.js', __FILE__ ) ,array ('jquery'), false, true );
    wp_register_script( 'jqmousewheel', plugins_url( '/js/jquery.mousewheel.js', __FILE__ ),array ('jquery'), false, true );
    wp_register_script( 'mwheelIntent', plugins_url( '/js/mwheelIntent.js', __FILE__ ),array ('jquery'), false, true );
}
